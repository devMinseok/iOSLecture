...
struct ColorModel {
    ...
    // Custom Color
    let summerGames = [#colorLiteral(red: 0.5725490196, green: 0.9960784314, blue: 0.6156862745, alpha: 1),#colorLiteral(red: 0, green: 0.7882352941, blue: 1, alpha: 1)]
    
    func createColorTable() -> [Int: [UIColor]] {
        let colorTable: [Int: [UIColor]] = [0: red, 1: orangeRed, 2: yellow, 3: green,
                                            4: greenBlue, 5: kindaBlue, 6: skyBlue, 7: blue,
                                            8: bluePurple, 9: purple, 10: pink, 11: summerGames]
